...
df2 = pd.DataFrame({
    'time':[21.84,22.00,22.25,22.50,22.75,23.00,23.50,24.00,24.50,25.00,25.50,26.00,26.50,27.00,27.50,28.00,28.50,29.00,29.50,30.00,30.50,31.00,31.25,31.50,31.75,32.00,40.00,50.00,60.00,70.00,80.00,90.00,100.00],
    'point':[1000,978,945,914,884,856,802,753,708,666,628,592,559,529,500,474,450,427,405,385,367,349,341,333,325,317,162,83,48,30,20,14,48]
})
...
for i in range(0,33):
    a = round((X.iloc[i,0]) * (Y.iloc[i,0]),3)
    a_round = round(a,2)
